...
class NlxHeader(OrderedDict):
    ...
    txt_header_keys = [
        ...
        ('DspFilterDelay_s', '', None), # add in from DECODE xplorefinder.m 
        ('sylvain_export', '', None), # add in from DECODE xplorefinder.m
        ...
        # header variables for VT1.nvt - JS 9/22/23
        ('VideoFormat','',None),
    ...
    def __init__(self, filename):
        ...
        if an == 'Cheetah':
            ...
            av = "NA"
            hpd = NlxHeader.header_pattern_dicts['def']
        #print(av == Version('5.6.3'))
        #print(hpd['datetime1_regex'])
